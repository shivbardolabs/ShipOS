...
async function main() {
  ...
  const customerData = [
    // Active physical customers
    {
      ...
      proofOfAddressDateOfIssue: new Date("2024-01-10"),
    ...
    },
    {
      ...
      proofOfAddressType: "current_lease",
      proofOfAddressDateOfIssue: new Date("2023-11-15"),
      proofOfAddressStatus: "approved",
      notifyEmail: true,
      notifySms: false,
    ...
    },
    {
      ...
      proofOfAddressDateOfIssue: new Date("2024-05-20"),
      proofOfAddressStatus: "approved",
      notifyEmail: true,
      notifySms: true,
