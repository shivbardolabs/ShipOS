...
export const reportCategories: ReportCategory[] = [
  ...
  },
  {
    ...
    description: 'Physical vs digital platform performance comparison',
    href: '/dashboard/reports/platform',
    iconName: 'Monitor',
  ...
  },
  {
    ...
    description: 'Carrier-level reporting with HAL & Access Point tracking',
    href: '/dashboard/reports/carrier',
    iconName: 'Truck',
  ...
  },
  {
    ...
    description: 'Amazon Counter, Vinted, PUDO Point, and more',
    href: '/dashboard/reports/programs',
    iconName: 'Layers',
    color: 'bg-violet-500/20 text-violet-400',
  },
  {
    id: 'returns',
    title: 'Returns Programs',
    description: 'FedEx Easy Returns and Happy Returns reporting',
  ...
  {
    id: 'customers',
    title: 'Customer / PMB Analytics',
    description: 'Per-customer insights, rankings, PMB status, and segmentation',
  ...
  },
  {
    ...
    description: 'Interactive visualizations, dashboards, and business intelligence',
