...
export const roleConfig: Record<UserRole, RoleConfig> = {
  superadmin: {
    label: 'Super Admin',
    icon: ShieldCheck,
    badgeBg: 'bg-status-error-50 dark:bg-status-error-500/15',
    badgeText: 'text-rose-700 dark:text-status-error-400',
    badgeBorder: 'border-status-error-200 dark:border-status-error-500/25',
    dot: 'bg-status-error-500',
    stripFrom: 'var(--color-status-error-600)',
    stripTo: '#f43f5e',
    ring: 'ring-status-error-400/40',
  },
  admin: {
    label: 'Admin',
    icon: Shield,
    badgeBg: 'bg-violet-50 dark:bg-status-violet-500/15',
    badgeText: 'text-status-violet-700 dark:text-status-violet-400',
    badgeBorder: 'border-violet-200 dark:border-status-violet-500/25',
    dot: 'bg-status-violet-500',
    stripFrom: 'var(--color-status-violet-600)',
    stripTo: 'var(--color-status-violet-500)',
    ring: 'ring-status-violet-400/40',
  },
  manager: {
    label: 'Manager',
    icon: UserCog,
    badgeBg: 'bg-status-warning-50 dark:bg-status-warning-500/15',
    badgeText: 'text-status-warning-700 dark:text-status-warning-400',
    badgeBorder: 'border-status-warning-200 dark:border-status-warning-500/25',
    dot: 'bg-status-warning-500',
    stripFrom: 'var(--color-status-warning-600)',
    stripTo: 'var(--color-status-warning-500)',
    ring: 'ring-status-warning-400/40',
  },
  employee: {
    label: 'Employee',
    icon: UserCheck,
    badgeBg: 'bg-teal-50 dark:bg-accent-teal/15',
    badgeText: 'text-teal-700 dark:text-teal-400',
    badgeBorder: 'border-teal-200 dark:border-accent-teal/25',
    dot: 'bg-accent-teal',
    stripFrom: '#0891b2',
    stripTo: 'var(--color-accent-teal)',
