...
export function PaymentMethodsPanel({ customerId }: PaymentMethodsPanelProps) {
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <p className="text-sm text-surface-400">
          {methods.length === 0 ? 'No payment methods on file' : `${methods.length} payment method${methods.length !== 1 ? 's' : ''}`}
        </p>
        {isAdmin && (
