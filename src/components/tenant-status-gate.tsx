...
export function TenantStatusGate({ children }: { children: React.ReactNode }) {
      ...
      <div className="min-h-screen flex items-center justify-center bg-surface-950 px-4">
        <div className="max-w-md w-full text-center">
          <div className="flex items-center justify-center mb-6">
            <div className="flex h-20 w-20 items-center justify-center rounded-2xl" style={{ background: 'color-mix(in srgb, var(--color-status-warning-500) 10%, transparent)' }}>
              <PauseCircle className="h-10 w-10 text-status-warning-500" />
            </div>
          </div>
          ...
          <div className="rounded-xl border border-status-warning-500/20 bg-status-warning-500/5 p-4 mb-6">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-surface-950 px-4">
      <div className="max-w-md w-full text-center">
        <div className="flex items-center justify-center mb-6">
          <div className="flex h-20 w-20 items-center justify-center rounded-2xl" style={{ background: 'color-mix(in srgb, var(--color-status-error-500) 10%, transparent)' }}>
            <XCircle className="h-10 w-10 text-status-error-500" />
          </div>
        </div>
