...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-surface-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_40%,rgba(99,102,241,0.04)_100%)]" />
        ...
        <div className="rounded-2xl p-8 shadow-2xl shadow-slate-200/30" style={{ background: '#ffffff', border: '1px solid #e2e8f0' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                onFocus={(e) => { e.target.style.borderColor = '#4F46E5'; e.target.style.boxShadow = '0 0 0 3px rgba(99, 102, 241, 0.15)'; }}
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 text-surface-600" style={{ background: '#ffffff' }}>or</span>
            </div>
          </div>
