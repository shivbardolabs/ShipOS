...
/**
 * Error boundary for the Master Admin section.
 *
 * Catches unhandled client-side exceptions and displays a user-friendly
 * message with the actual error details to help debug production issues.
 */
...
export default function AdminError({
  ...
  useEffect(() => {
    // Log error to console for PostHog session replay visibility
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
      ...
      <p className="text-surface-400 max-w-lg mb-6">
        The Master Admin panel encountered an error. This may be a temporary
